...
<div class="col-lg-4">
                         ...
                         <asp:TextBox ID="txtbv"  placeholder="Enter Product PV"   runat="server" CssClass="form-control"></asp:TextBox>
                          ...
                          <label class="control-label col-lg-2">After 50% Capping </label>
<div class="col-lg-4">
                         <asp:TextBox ID="txtdesc" placeholder="Enter After 50% Capping"   runat="server" CssClass="form-control"></asp:TextBox>
                          ...
                          <label class="control-label col-lg-2">Capping</label>
                          <div class="col-lg-4">
                         <asp:TextBox ID="txtdirect"  placeholder="Enter Capping"   runat="server" CssClass="form-control"></asp:TextBox>
                          
                          </div>
                          <%--<label class="control-label col-lg-2">Product Description </label>
<div class="col-lg-4">
                         <asp:TextBox ID="TextBox2" placeholder="Enter Product Description"   runat="server" CssClass="form-control"></asp:TextBox>
